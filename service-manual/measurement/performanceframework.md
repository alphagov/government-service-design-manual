...
###Checklist
a. Are your metrics simple, actionable and collectable?
b. Have you mapped your metrics to the relevant audience?
c. Have you identified where your metrics will be sourced from?
d. Do you know how frequently performance information is required by your users?
...
a.Have you installed and configured digital/web analytics
b.Have you configured your web analytics software with the appropriate [conversion funnels?](http://en.wikipedia.org/wiki/Conversion_funnel)
c.Do you have the capability to run user satisfaction surveys?
d.Do you have the capability to do [A/B testing](http://en.wikipedia.org/wiki/Ab_testing) and [multivariate testing?](http://en.wikipedia.org/wiki/Multivariate_testing)
...
b.Have you done any  [A/B testing](http://en.wikipedia.org/wiki/Ab_testing) or [multivariate testing?](http://en.wikipedia.org/wiki/Multivariate_testing) 

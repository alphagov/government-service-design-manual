...
3. Is this user need of sufficient importance to (your users to) justify the lifetime cost of your proposed app? If you believe it is, how have you determined this? You might find it useful to review articles within the service manual such as, [Know your users](/service-manual/user-centred-design) and [Writing user stories](/service-manual/agile/writing-user-stories.html).

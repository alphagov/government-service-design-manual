...
Where there is an an existing software solution which solves your problem, you should certainly consider using it. For the purposes of making this decision, making use of a piece of open source is effectively _buying_ that piece of software.

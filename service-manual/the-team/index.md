...
Regardless of the delivery approach, all transactional services need to have a [service manager](/service-manual/the-team/service-manager).
...
* analyse [user needs](/service-manual/user-centred-design/user-needs), and turn these into [user stories](/service-manual/agile/writing-user-stories)
* manage the scope and prioritisation of stories
* manage and report to stakeholders
* managing dependencies on other teams
* where needed, [procure services or solutions from 3rd parties](/service-manual/the-team/working-with-specialists)
* design, build, test, demo and iterate software solutions (the 'making'!)
* [test solutions](/service-manual/user-centred-design/user-research/) on real users
* [deploy and host](/service-manual/operations/hosting) the software
* find solutions for [accrediting and handling of data](/service-manual/making-software/information-security)
* [supporting the live running of the service](/service-manual/operations/) (monitoring, fixing things when they break, responding to users)
...
* a [service manager](/service-manual/the-team/service-manager.html) (the 'product owner')
	...
	* supported by one or more [digital performance analysts](/service-manual/the-team/recruitment/performance-analyst-jd)
* a [delivery manager](/service-manual/the-team/delivery-manager)
* a tech lead
* one or more [designers](/service-manual/the-team/designer)

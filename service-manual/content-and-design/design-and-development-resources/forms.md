...
Check out the [registration form example](/service-manual/registration-form.html) to see the different layout options in action.
...
See the [seperate page on buttons](/service-manual/buttons.html) for detailed guidance on how to style and word them.
...
To see all the examples above in a single form, check out the [registration form example](/service-manual/registration-form.html).

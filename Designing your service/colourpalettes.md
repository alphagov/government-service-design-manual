...
<div class="swatches">
  <div class="link-colour"><p>Sass: $link-colour</p><p>Hex: #2e3191</p></div>
  <div class="link-active-colour"><p>Sass: $link-active-colour</p><p>Hex: #2e8aca</p></div>
  <div class="text-colour"><p>Sass: $text-colour</p><p>Hex: #0b0c0c</p></div>

  <div class="link-visited-colour"><p>Sass: $link-visited-colour</p><p>Hex: #2e3191</p></div>
  <div class="link-hover-colour"><p>Sass: $link-hover-colour</p><p>Hex: #2e8aca</p></div>
</div>
...
<h2>Standard palette, greys</h2>
<div class="swatches">
  <div>
    <ul>
      <li class="charcoal-grey"><p>Sass: $charcoal-grey</p><p>Hex: #231f20</p></li>
      <li class="dark-blue-grey"><p>Sass: $dark-blue-grey</p><p>Hex: #083640</p></li>
      <li class="light-blue-grey"><p>Sass: $light-blue-grey</p><p>Hex: #c1cacb</p></li>
    </ul>
  </div>
  <div>
    <ul>
      <li class="light-warm-grey"><p>Sass: $light-warm-grey</p><p>Hex: #e1e8e8</p></li>
      <li class="cool-grey"><p>Sass: $cool-grey</p><p>Hex: #e8f0f0</p></li>
      <li class="white"><p>Sass: $white</p><p>Hex: #ffffff</p></li>
    </ul>
  </div>
  <div>
    <ul>
      <li class="light-beige"><p>Sass: $light-beige</p><p>Hex: #f8f7ee</p></li>
      <li class="light-tan"><p>Sass: $light-tan</p><p>Hex: #f5f0d6</p></li>
    </ul>
  </div>
</div>
...
<div class="swatches">
  <div>
    <ul>
      <li class="black"><p>Sass: $black</p><p>Hex: #000</p></li>
      <li class="grey-20"><p>Sass: $grey-20</p><p>Hex: #333</p></li>
      <li class="grey-40"><p>Sass: $grey-40</p><p>Hex: #666</p></li>
    </ul>
  </div>
  <div>
    <ul>
      <li class="grey-63"><p>Sass: $grey-63</p><p>Hex: #a2a2a2</p></li>
      <li class="grey-76"><p>Sass: $grey-76</p><p>Hex: #c2c2c2</p></li>
      <li class="grey-88"><p>Sass: $grey-88</p><p>Hex: #e2e2e2</p></li>
    </ul>
  </div>
  <div>
    <ul>
      <li class="grey-95"><p>Sass: $grey-95</p><p>Hex: #f2f2f2</p></li>
      <li class="white"><p>Sass: $white</p><p>Hex: #fff</p></li>
    </ul>
  </div>
</div>

<h2>'New' greys</h2>
<p>These aren't in the toolkit gem yet, but they will be.</p>
<div class="swatches">
  <div>
    <ul>
      <li class="grey-0"><p>Sass: $grey-0</p><p>Hex: #0b0c0c</p></li>
      <li class="grey-1"><p>Sass: $grey-1</p><p>Hex: #171819</p></li>
      <li class="grey-2"><p>Sass: $grey-2</p><p>Hex: #2e3133</p></li>
      <li class="grey-3"><p>Sass: $grey-3</p><p>Hex: #454a4c</p></li>
    </ul>
  </div>
  <div>
    <ul>
      <li class="grey-4"><p>Sass: $grey-4</p><p>Hex: #5c6366</p></li>
      <li class="grey-5"><p>Sass: $grey-5</p><p>Hex: #8a9499</p></li>
      <li class="grey-6"><p>Sass: $grey-6</p><p>Hex: #a1acb2</p></li>
      <li class="grey-7"><p>Sass: $grey-7</p><p>Hex: #b8c6cc</p></li>
    </ul>
  </div>
  <div>
    <ul>
      <li class="grey-8"><p>Sass: $grey-8</p><p>Hex: #DEE0E2</p></li>
      <li class="grey-9"><p>Sass: $grey-9</p><p>Hex: #eaedef</p></li>
    </ul>
  </div>
</div>
<h2>Pure greys</h2>
<div class="swatches">
  <div>
    <ul>
      <li class="new-black"><p>Sass: $black</p><p>Hex: #0b0c0c</p></li>
    </ul>
  </div>
  <div>
    <ul>
      <li class="true-black"><p>Sass: $true-black</p><p>Hex: #000</p></li>
    </ul>
  </div>
  <div>
    <ul>
...
<!-- DEPT. COLOURS -->
  ...
  <h2>Government department colours</h2>

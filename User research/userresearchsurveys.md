...
* Online web surveys – self-completion surveys used to obtain information from web users. Surveys are activated when a user interacts with a page – this can either be through arriving/leaving a page, or clicking on a link. A piece of computer script used to control the frequency at which users are invited to take part in a survey e.g. 1:n users will get invited to take a specific survey. I order to increase completion rate, online surveys are normally no longer than 5-10 mins in length (approximately 20 – 25 questions). For more details on how to conduct online surveys please see survey design in section 8 for more details.
* Email survey – these are identical in set up and design to online web surveys, except they are participants are asked to complete then via an email, and not at random via when they visit a website. Email surveys are often more target as participants can be identified by information already know about the user e.g. demographic, information usage etc.
...
Questions can be misunderstood – surveys need to be designed carefully to avoid this (see section 8).
Completion bias – one common criticism of some types of surveys is that they are only completed by people who have something to say e.g. are either very satisfied or very dissatisfied. This can be over come via conduct face to face interviews and employing sophisticated sampling techniques, although this is normally expensive. Please see section 8 for more information on sample techniques.
